...
output "security_groups_id" {
  value = data.aws_security_group.jenkins-SG.id
}
...
output "management_vpc_id" {
  value = data.aws_vpc.management-VPC.id
}
...
output "management_Pub_RT_ID" {
  value = data.aws_route_table.manage-public-RT.id
}

output "management_Pri_RT_ID" {
  value = data.aws_route_table.manage-Private-RT.id
}


######################### Openvpn sg ####################

output "openVPN-sg-id" {
